<template>
  <div class="main">
    ...
    <div class="encrypt-line">
      <input ref="txtNumberToEncrypt" class="form-control" type="text" placeholder="Type a number to encrypt" />
      <button class="btn btn-success" @click="encrypt_address(txtNumberToEncrypt)">Encrypt</button>
    </div>
